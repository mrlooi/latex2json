...
def test_parse_equations(parsed_training_tokens):
    equations = [token for token in parsed_training_tokens if token["type"] == "equation"]
    # inline equations = 7
...
def test_parse_citations(parsed_training_tokens):
    ...
    citations = [token for token in parsed_training_tokens if token["type"] == "citation"]
