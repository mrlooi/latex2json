...
from latex_parser.parser.bib_parser import BibEntry, BibParser
from latex_parser.utils.logger import setup_logger

sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))


from latex_parser.parser.handlers import (
    CodeBlockHandler,
    EquationHandler,
    TokenHandler,
...
from latex_parser.parser.handlers.environment import BaseEnvironmentHandler
...
from latex_parser.parser.patterns import (
    PATTERNS,
    USEPACKAGE_PATTERN,
